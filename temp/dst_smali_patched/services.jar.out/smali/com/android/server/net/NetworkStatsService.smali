...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/net/NetworkStatsService;->mPerformPoll:Ljava/lang/Object;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/app/IAlarmManager;Landroid/util/TrustedTime;Ljava/io/File;Lcom/android/server/net/NetworkStatsService$NetworkStatsSettings;)V
    ...
    iput-boolean v4, p0, Lcom/android/server/net/NetworkStatsService;->mIsVideoCall:Z
    ...
    iput-object v2, p0, Lcom/android/server/net/NetworkStatsService;->mVideoCallReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$1000(Lcom/android/server/net/NetworkStatsService;)Z
    ...
    .prologue
    iget-boolean v0, p0, Lcom/android/server/net/NetworkStatsService;->mIsVideoCall:Z
...
.method static synthetic access$1002(Lcom/android/server/net/NetworkStatsService;Z)Z
    ...
    .prologue
    iput-boolean p1, p0, Lcom/android/server/net/NetworkStatsService;->mIsVideoCall:Z
...
.method static synthetic access$1302(Lcom/android/server/net/NetworkStatsService;Z)Z
    ...
    .prologue
    iput-boolean p1, p0, Lcom/android/server/net/NetworkStatsService;->mIsDuringVideoCall:Z
...
.method private performPollLocked(I)V
    ...
    const-string v13, "performPollLocked(flags=0x"
    ...
    const-string v13, "performPollLocked() took "
    ...
    const-string v12, "problem reading network stats"
...
.method private registerPollAlarmLocked()V
    ...
    iget-object v2, p0, Lcom/android/server/net/NetworkStatsService;->mPollIntent:Landroid/app/PendingIntent;

    if-eqz v2, :cond_0

    iget-object v2, p0, Lcom/android/server/net/NetworkStatsService;->mAlarmManager:Landroid/app/AlarmManager;

    iget-object v3, p0, Lcom/android/server/net/NetworkStatsService;->mPollIntent:Landroid/app/PendingIntent;
    ...
    iput-object v2, p0, Lcom/android/server/net/NetworkStatsService;->mPollIntent:Landroid/app/PendingIntent;
    ...
    iget-boolean v2, p0, Lcom/android/server/net/NetworkStatsService;->mIsDuringVideoCall:Z

    if-ne v2, v5, :cond_1

    const-string v2, "NetworkStats"

    const-string v3, "registerPollAlarmLocked() - repeats as 5000"

    invoke-static {v2, v3}, Landroid/util/Slog;->v(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v2, p0, Lcom/android/server/net/NetworkStatsService;->mHandler:Landroid/os/Handler;

    sget-object v3, Lcom/android/server/net/NetworkStatsService;->mPerformPoll:Ljava/lang/Object;
    ...
    sget-object v4, Lcom/android/server/net/NetworkStatsService;->mPerformPoll:Ljava/lang/Object;
...
.method private shutdownLocked()V
    ...
    iget-object v3, p0, Lcom/android/server/net/NetworkStatsService;->mVideoCallReceiver:Landroid/content/BroadcastReceiver;
...
.method public getNetworkStatsVideoCall(II)Landroid/net/NetworkStats;
    ...
    const-string v6, "problem in reading Video call network stats"
...
.method public startNetworkStatsOnPorts(Ljava/lang/String;II)V
    ...
    const-string v4, "starting stats count for: "
...
.method public stopNetworkStatsOnPorts(Ljava/lang/String;II)V
    ...
    const-string v4, "stopping stats count for: "
...
.method public systemReady()V
    ...
    iget-object v7, p0, Lcom/android/server/net/NetworkStatsService;->mVideoCallReceiver:Landroid/content/BroadcastReceiver;
