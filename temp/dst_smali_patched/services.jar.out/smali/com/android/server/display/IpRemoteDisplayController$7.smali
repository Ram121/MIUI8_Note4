...
.method public onDisplayConnected(Landroid/view/Surface;IIII)V
    ...
    invoke-static {v0}, Lcom/android/server/display/IpRemoteDisplayController;->access$1400(Lcom/android/server/display/IpRemoteDisplayController;)Landroid/media/RemoteDisplay;
    ...
    invoke-static {v0}, Lcom/android/server/display/IpRemoteDisplayController;->access$1600(Lcom/android/server/display/IpRemoteDisplayController;)Landroid/os/Handler;
    ...
    invoke-static {v2}, Lcom/android/server/display/IpRemoteDisplayController;->access$1500(Lcom/android/server/display/IpRemoteDisplayController;)Ljava/lang/Runnable;
    ...
    invoke-static {v0}, Lcom/android/server/display/IpRemoteDisplayController;->access$1700(Lcom/android/server/display/IpRemoteDisplayController;)Landroid/media/WFDUibcManager;
    ...
    invoke-static {v0, v2}, Lcom/android/server/display/IpRemoteDisplayController;->access$1800(Lcom/android/server/display/IpRemoteDisplayController;Landroid/net/wifi/p2p/WifiP2pDevice;)Landroid/hardware/display/WifiDisplay;
    ...
    invoke-static {v0}, Lcom/android/server/display/IpRemoteDisplayController;->access$1900(Lcom/android/server/display/IpRemoteDisplayController;)I
    ...
    # getter for: Lcom/android/server/display/IpRemoteDisplayController;->mConnectState:I
    invoke-static {v2}, Lcom/android/server/display/IpRemoteDisplayController;->access$1900(Lcom/android/server/display/IpRemoteDisplayController;)I
    ...
    invoke-static/range {v0 .. v6}, Lcom/android/server/display/IpRemoteDisplayController;->access$2000(Lcom/android/server/display/IpRemoteDisplayController;Landroid/hardware/display/WifiDisplay;Landroid/view/Surface;IIII)V
    ...
    invoke-static {v0, v8, v2}, Lcom/android/server/display/IpRemoteDisplayController;->access$1300(Lcom/android/server/display/IpRemoteDisplayController;II)V
...
.method public onDisplayDisconnected()V
    ...
    # getter for: Lcom/android/server/display/IpRemoteDisplayController;->mRtspTimeout:Ljava/lang/Runnable;
    invoke-static {v1}, Lcom/android/server/display/IpRemoteDisplayController;->access$1500(Lcom/android/server/display/IpRemoteDisplayController;)Ljava/lang/Runnable;
...
.method public onDisplayError(I)V
    ...
    invoke-static {v0, v3}, Lcom/android/server/display/IpRemoteDisplayController;->access$2100(Lcom/android/server/display/IpRemoteDisplayController;Z)V
