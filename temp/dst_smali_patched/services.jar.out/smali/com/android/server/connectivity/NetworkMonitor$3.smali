...
.method public onForegroundActivitiesChanged(IIZ)V
    ...
    invoke-static {v4, v9}, Lcom/android/server/connectivity/NetworkMonitor;->access$4000(Lcom/android/server/connectivity/NetworkMonitor;I)V

    iget-object v4, p0, Lcom/android/server/connectivity/NetworkMonitor$3;->this$0:Lcom/android/server/connectivity/NetworkMonitor;

    # setter for: Lcom/android/server/connectivity/NetworkMonitor;->mCurrentUid:I
    invoke-static {v4, p2}, Lcom/android/server/connectivity/NetworkMonitor;->access$4102(Lcom/android/server/connectivity/NetworkMonitor;I)I
    ...
    invoke-static {v4, v6, v7}, Lcom/android/server/connectivity/NetworkMonitor;->access$4202(Lcom/android/server/connectivity/NetworkMonitor;J)J
    ...
    const-string v6, "onForegroundActivitiesChanged: pid-"
    ...
    invoke-static {v6}, Lcom/android/server/connectivity/NetworkMonitor;->access$4300(Lcom/android/server/connectivity/NetworkMonitor;)Z
    ...
    invoke-static {v4}, Lcom/android/server/connectivity/NetworkMonitor;->access$3900(Lcom/android/server/connectivity/NetworkMonitor;)Z
    ...
    const-string v5, "onForegroundActivitiesChanged: calling state"
    ...
    const-string v5, "onForegroundActivitiesChanged: mobile data not connected"
    ...
    const-string v5, "onForegroundActivitiesChanged: skip system uid"
    ...
    invoke-static {v4}, Lcom/android/server/connectivity/NetworkMonitor;->access$4400(Lcom/android/server/connectivity/NetworkMonitor;)Z
    ...
    const-string v5, "onForegroundActivitiesChanged: DO NOT check after captiveportallogin"
    ...
    invoke-static {v4, v8}, Lcom/android/server/connectivity/NetworkMonitor;->access$4402(Lcom/android/server/connectivity/NetworkMonitor;Z)Z
    ...
    # setter for: Lcom/android/server/connectivity/NetworkMonitor;->mIsCaptivePortalLoginActivity:Z
    invoke-static {v4, v5}, Lcom/android/server/connectivity/NetworkMonitor;->access$4402(Lcom/android/server/connectivity/NetworkMonitor;Z)Z

    :cond_5
    iget-object v4, p0, Lcom/android/server/connectivity/NetworkMonitor$3;->this$0:Lcom/android/server/connectivity/NetworkMonitor;

    # getter for: Lcom/android/server/connectivity/NetworkMonitor;->mIsCaptivePortalLoginActivityCreated:Z
    invoke-static {v4}, Lcom/android/server/connectivity/NetworkMonitor;->access$4300(Lcom/android/server/connectivity/NetworkMonitor;)Z
    ...
    invoke-static {v4, v2}, Lcom/android/server/connectivity/NetworkMonitor;->access$4500(Lcom/android/server/connectivity/NetworkMonitor;Ljava/lang/String;)Z
    ...
    invoke-static {v4, v8}, Lcom/android/server/connectivity/NetworkMonitor;->access$4602(Lcom/android/server/connectivity/NetworkMonitor;I)I
