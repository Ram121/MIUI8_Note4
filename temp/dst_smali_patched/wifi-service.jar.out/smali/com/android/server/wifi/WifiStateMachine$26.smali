...
.method constructor <init>(Lcom/android/server/wifi/WifiStateMachine;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLandroid/content/res/Resources;)V
    ...
    iput-object p2, p0, Lcom/android/server/wifi/WifiStateMachine$26;->val$ip:Ljava/lang/String;

    iput-object p3, p0, Lcom/android/server/wifi/WifiStateMachine$26;->val$fp:Ljava/lang/String;

    iput-object p4, p0, Lcom/android/server/wifi/WifiStateMachine$26;->val$sn:Ljava/lang/String;

    iput-object p5, p0, Lcom/android/server/wifi/WifiStateMachine$26;->val$ssid:Ljava/lang/String;

    iput-boolean p6, p0, Lcom/android/server/wifi/WifiStateMachine$26;->val$disconnect:Z

    iput-object p7, p0, Lcom/android/server/wifi/WifiStateMachine$26;->val$r:Landroid/content/res/Resources;
...
.method public run()V
    ...
    .local v8, "PORT":I
    :try_start_0
    iget-object v1, p0, Lcom/android/server/wifi/WifiStateMachine$26;->this$0:Lcom/android/server/wifi/WifiStateMachine;
    ...
    invoke-static {v1, v2}, Lcom/android/server/wifi/WifiStateMachine;->access$47002(Lcom/android/server/wifi/WifiStateMachine;Ljava/net/Socket;)Ljava/net/Socket;

    new-instance v10, Ljava/net/InetSocketAddress;

    iget-object v1, p0, Lcom/android/server/wifi/WifiStateMachine$26;->val$ip:Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/android/server/wifi/WifiStateMachine;->access$47000(Lcom/android/server/wifi/WifiStateMachine;)Ljava/net/Socket;
    ...
    # getter for: Lcom/android/server/wifi/WifiStateMachine;->ClientSocket:Ljava/net/Socket;
    invoke-static {v2}, Lcom/android/server/wifi/WifiStateMachine;->access$47000(Lcom/android/server/wifi/WifiStateMachine;)Ljava/net/Socket;

    move-result-object v2

    iget-object v3, p0, Lcom/android/server/wifi/WifiStateMachine$26;->val$ip:Ljava/lang/String;

    iget-object v4, p0, Lcom/android/server/wifi/WifiStateMachine$26;->val$fp:Ljava/lang/String;

    iget-object v5, p0, Lcom/android/server/wifi/WifiStateMachine$26;->val$sn:Ljava/lang/String;

    iget-object v6, p0, Lcom/android/server/wifi/WifiStateMachine$26;->val$ssid:Ljava/lang/String;

    iget-boolean v7, p0, Lcom/android/server/wifi/WifiStateMachine$26;->val$disconnect:Z
    ...
    iget-object v2, p0, Lcom/android/server/wifi/WifiStateMachine$26;->val$r:Landroid/content/res/Resources;
    ...
    :goto_1
    iget-boolean v1, p0, Lcom/android/server/wifi/WifiStateMachine$26;->val$disconnect:Z
