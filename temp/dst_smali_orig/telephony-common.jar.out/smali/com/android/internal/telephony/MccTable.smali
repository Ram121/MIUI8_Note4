...
.method public static updateMccMncConfiguration(Landroid/content/Context;Ljava/lang/String;Z)V
    ...
    const-string v14, "updateMccMncConfiguration mccmnc=\'"
    ...
    const-string v14, "\' fromServiceState="
    ...
    const-string v12, "persist.sys.override_mcc"

    invoke-static {v12}, Landroid/os/SystemProperties;->get(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v10

    .local v10, "overrideMcc":Ljava/lang/String;
    ...
    const-string v14, "updateMccMncConfiguration overriding mccmnc=\'"
    ...
    .end local v10    # "overrideMcc":Ljava/lang/String;
    :cond_0
    ...
    invoke-virtual {v12}, Landroid/telephony/TelephonyManager;->getSimOperatorNumeric()Ljava/lang/String;

    move-result-object v3

    .local v3, "defaultMccMnc":Ljava/lang/String;
    const-string v12, "MccTable"
    ...
    const-string v14, "updateMccMncConfiguration defaultMccMnc="
    ...
    const-string v14, "updateMccMncConfiguration: mcc="
    ...
    invoke-static {v0, v8}, Lcom/android/internal/telephony/MccTable;->setTimezoneFromMccIfNeeded(Landroid/content/Context;I)V
    ...
    invoke-static {v0, v8}, Lcom/android/internal/telephony/MccTable;->setWifiCountryCodeFromMcc(Landroid/content/Context;I)V

    .end local v3    # "defaultMccMnc":Ljava/lang/String;
    .end local v8    # "mcc":I
    .end local v9    # "mnc":I
    :cond_2
    :goto_0
    ...
    .restart local v3    # "defaultMccMnc":Ljava/lang/String;
    :catch_0
    move-exception v4
    ...
    const-string v14, "Error parsing IMSI: "
    ...
    .local v11, "updateConfig":Z
    if-eqz v8, :cond_5

    const/4 v2, 0x0

    .local v2, "countryISO":Ljava/lang/String;
    const-string v12, "ro.csc.countryiso_code"
    ...
    invoke-static {}, Lcom/android/internal/telephony/MccTable;->getMainOperatorName()Ljava/lang/String;
    ...
    const-string v12, "ro.cdma.home.operator.numeric"
    ...
    .local v7, "homeMnc":I
    iput v5, v1, Landroid/content/res/Configuration;->mcc:I
    ...
    const-string v14, "updateMccMncConfiguration updateConfig config="
    ...
    invoke-interface {v12, v1}, Landroid/app/IActivityManager;->updateConfiguration(Landroid/content/res/Configuration;)V
    :try_end_3
    ...
    const-string v13, "Can\'t update configuration"
    ...
    .restart local v9    # "mnc":I
    .restart local v11    # "updateConfig":Z
    :cond_9
    :try_start_4
    iput v8, v1, Landroid/content/res/Configuration;->mcc:I
    ...
    const-string v13, "Error parsing ro.cdma.home.operator.numeric. Update config using IMSI"
    ...
    const-string v15, "updateMccMncConfiguration for SPR: mcc="
    ...
    const-string v13, "updateMccMncConfiguration nothing to update"
