...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/wifi/WifiServiceImpl;Ljava/lang/String;)V
    ...
    iput-object v1, p0, Lcom/android/server/wifi/WifiTrafficPoller;->mCpuBooster:Landroid/os/DVFSHelper;

    iput-object v1, p0, Lcom/android/server/wifi/WifiTrafficPoller;->mCpuCstate:Landroid/os/DVFSHelper;

    iput-object v1, p0, Lcom/android/server/wifi/WifiTrafficPoller;->mCpuCoreBooster:Landroid/os/DVFSHelper;

    iput-object v1, p0, Lcom/android/server/wifi/WifiTrafficPoller;->mLegacySched:Landroid/os/DVFSHelper;

    iput-object v1, p0, Lcom/android/server/wifi/WifiTrafficPoller;->mCstateDisable:Landroid/os/DVFSHelper;

    iput-object v1, p0, Lcom/android/server/wifi/WifiTrafficPoller;->mLpm:Landroid/os/DVFSHelper;

    iput-object v1, p0, Lcom/android/server/wifi/WifiTrafficPoller;->mMifBooster:Landroid/os/DVFSHelper;
    ...
    iput v2, p0, Lcom/android/server/wifi/WifiTrafficPoller;->mCurrentDelAckSize:I

    iput v2, p0, Lcom/android/server/wifi/WifiTrafficPoller;->mCurrentL1ssCtrl:I

    iput-boolean v10, p0, Lcom/android/server/wifi/WifiTrafficPoller;->mSetMif:Z
...
.method public notifyOnDataActivity()V
    ...
    invoke-static/range {v36 .. v36}, Landroid/net/TrafficStats;->getTxPackets(Ljava/lang/String;)J
    ...
    invoke-static/range {v36 .. v36}, Landroid/net/TrafficStats;->getRxPackets(Ljava/lang/String;)J
    ...
    const-string v36, "WifiTrafficPoller"

    new-instance v37, Ljava/lang/StringBuilder;

    invoke-direct/range {v37 .. v37}, Ljava/lang/StringBuilder;-><init>()V

    const-string v38, " packet count Tx="
    ...
    invoke-static/range {v36 .. v36}, Landroid/net/TrafficStats;->getTxBytes(Ljava/lang/String;)J
    ...
    invoke-static/range {v36 .. v36}, Landroid/net/TrafficStats;->getRxBytes(Ljava/lang/String;)J
    ...
    sget-object v37, Lcom/android/server/wifi/WifiTrafficPoller;->mCurrentMode:Lcom/android/server/wifi/WifiTrafficPoller$BoosterMode;

    invoke-virtual/range {v37 .. v37}, Lcom/android/server/wifi/WifiTrafficPoller$BoosterMode;->ordinal()I

    move-result v37

    mul-int/lit8 v37, v37, 0x3

    add-int/lit8 v37, v37, 0x0
    ...
    mul-long v32, v36, v38

    .local v32, "threshold_1":J
    move-object/from16 v0, p0
    ...
    mul-long v34, v36, v38

    .local v34, "threshold_2":J
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v36 .. v36}, Landroid/os/DVFSHelper;->getSupportedCPUFrequency()[I
    ...
    .local v10, "max_pkt":J
    const-wide/32 v28, 0x2bc0000

    .local v28, "setdelack_tp":J
    const-wide/32 v26, 0x12c0000

    .local v26, "setL1ss_tp":J
    ...
    invoke-virtual {v0, v12}, Lcom/android/server/wifi/WifiServiceImpl;->callSECApi(Landroid/os/Message;)I
    ...
    const-string v38, "Dynamic booster is mCpuFreqIndex_0. mCpuFreqIndex_0 is "
    ...
    invoke-virtual/range {v36 .. v38}, Landroid/os/DVFSHelper;->addExtraOption(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual/range {v36 .. v37}, Landroid/os/DVFSHelper;->acquire(I)V
    ...
    const-string v37, "mCpuCstate Lock"
    ...
    const-string v37, "mCpuCoreBooster Lock"
    ...
    const-string v38, "notifying of data activity "
    ...
    const-string v38, "Dynamic booster is mCpuFreqIndex_1. mCpuFreqIndex_1 is "
    ...
    const-string v38, "Dynamic booster is mCpuFreqIndex_2. mCpuFreqIndex_2 is "
    ...
    .end local v26    # "setL1ss_tp":J
    .end local v28    # "setdelack_tp":J
    .end local v30    # "threshold_0":J
    .end local v32    # "threshold_1":J
    .end local v34    # "threshold_2":J
    :cond_f
    return-void
.end method
