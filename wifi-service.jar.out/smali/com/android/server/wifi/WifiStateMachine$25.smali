...
.method public run()V
    ...
    invoke-static {v2, v3}, Lcom/android/server/wifi/WifiStateMachine;->access$46702(Lcom/android/server/wifi/WifiStateMachine;Ljava/net/ServerSocket;)Ljava/net/ServerSocket;
    ...
    iget-object v3, p0, Lcom/android/server/wifi/WifiStateMachine$25;->this$0:Lcom/android/server/wifi/WifiStateMachine;

    # getter for: Lcom/android/server/wifi/WifiStateMachine;->serverSocket:Ljava/net/ServerSocket;
    invoke-static {v3}, Lcom/android/server/wifi/WifiStateMachine;->access$46700(Lcom/android/server/wifi/WifiStateMachine;)Ljava/net/ServerSocket;
    ...
    invoke-static {v2, v3}, Lcom/android/server/wifi/WifiStateMachine;->access$46802(Lcom/android/server/wifi/WifiStateMachine;Ljava/net/Socket;)Ljava/net/Socket;
    ...
    iget-object v4, p0, Lcom/android/server/wifi/WifiStateMachine$25;->this$0:Lcom/android/server/wifi/WifiStateMachine;

    # getter for: Lcom/android/server/wifi/WifiStateMachine;->socket:Ljava/net/Socket;
    invoke-static {v4}, Lcom/android/server/wifi/WifiStateMachine;->access$46800(Lcom/android/server/wifi/WifiStateMachine;)Ljava/net/Socket;
    ...
    # getter for: Lcom/android/server/wifi/WifiStateMachine;->socket:Ljava/net/Socket;
    invoke-static {v3}, Lcom/android/server/wifi/WifiStateMachine;->access$46800(Lcom/android/server/wifi/WifiStateMachine;)Ljava/net/Socket;
